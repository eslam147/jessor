                            ...
                            <div class="add-new-question-container" style="display:none">
                                <div class="bg-light p-4">
                                    <div class="form-group">
                                        <label>{{ __('question_type') }} <span class="text-danger">*</span></label> <button
                                            type="button"
                                            class="btn btn-danger btn-sm d-flex float-right remove-add-new-question"><i
                                                class="fa fa-times-circle" aria-hidden="true"></i></button><br>
                                        <div class="d-flex">
                                    ...
                                    <div id="equation-question" style="display: none">
                                        ...
                                        <div class="add_button_equations">
                                            <button class="btn btn-dark btn-sm" type="button"
                                                id="add-new-eqation-option"><i class="fa fa-plus-circle fa-3x mr-2"
                                                    aria-hidden="true"></i>{{ __('add_option') }}</button>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list_exam_questions'
                            data-toggle="table"
                                        ...
                                        @foreach ($exam_questions as $questions)
                                            @if ($questions->questions->question_type)
                                                <div class="list-group">
                                                    ...
                                                    <li
                                                        id="q{{ $questions->question_id }}"class="list-group-item d-flex justify-content-between align-items-center ui-state-default list-group-item-secondary m-2">
                                                        ...
                                                        <span class="text-right row">
                                                            <input type="number" class="list-group-item col-md-6"
                                                                name="assign_questions[{{ $questions->question_id }}][marks]"
                                                                style="width: 10rem" value="{{ $questions->marks }}"
                                                                min="0">
                                                            <a class="btn btn-danger btn-sm remove-row ml-2 mt-2 mb-2 mr-2"
                                            ...
                                            @else
                                                <div class="list-group">
                                                    ...
                                                    <li
                                                        id="q{{ $questions->question_id }}"class="list-group-item d-flex justify-content-between align-items-center ui-state-default list-group-item-secondary m-2">
                                                        {{ $questions->question_id }} <span
                                                            class="text-center">{{ htmlspecialchars_decode($questions->questions->question) }}</span>
                                                        <span class="text-right row">
                                                            <input type="number" class="list-group-item col-md-6"
                                                                name="assign_questions[{{ $questions->question_id }}][marks]"
                                                                style="width: 10rem" value="{{ $questions->marks }}"
