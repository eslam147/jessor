                                            ...
                                            <div class="box mb-15 pull-up {{ $loop->odd ? 'bg-primary-light' : '' }}">
                                                <div class="box-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        @if (!empty($lesson->studentActiveEnrollment) && !in_array($topic->id, $lockedTopics))
                                                            @include('student_dashboard.lessons.partials.locked_topic_btn',
                                                                [
                                                                    'isLocked' => false,
                                                                ]
                                                            )
                                                        @else
                                                            @include(
                                                                'student_dashboard.lessons.partials.locked_topic_btn',
                                                                [
                                                                    'isLocked' => true,
                                                                    'msg' => in_array($topic->id, $lockedTopics)
                                                                        ? 'Must Complete The Topics Before This'
