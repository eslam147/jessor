...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('student/assets/icons/material-design-iconic-font/css/materialdesignicons.css') }}">
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    ...
    <div class="wrapper">
        ...
        @include('student_dashboard.layout.nav')

        @include('student_dashboard.layout.sidbar')
