...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        {{-- Coupon --}}
        @can(['coupons-create', 'coupons-list'])
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#coupon-menu" aria-expanded="false"
                    aria-controls="academics-menu"><i class="fa fa-gift menu-icon" style="margin: 0 4px 0 4px"></i>
        ...
        @canany(['leave-setting-create', 'leave-list', 'leave-create', 'leave-delete', 'leave-edit'])
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#leave-menu" aria-expanded="false"><i
                        class="fa fa-plane menu-icon" style="margin: 0 2px 0 2px"></i>
                ...
                <div class="collapse" id="leave-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @canany(['leave-list', 'leave-approve'])
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('leave-report.index') }}">
                                    {{ __('leave') . ' ' . __('report') }}
                                </a>
                            </li>
                        @endcanany
                        @can('leave-approve')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('leave-request.index') }}">
                                    {{ __('staff') . ' ' . __('leave') }}
                                </a>
                            </li>
                        @endcan
                ...
                <div class="collapse" id="settings-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('fcm-setting-create')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('fcm-settings') }}">
