                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="category_name" data-sortable="false"
                                                data-visible="false">
                                                {{ __('category') }}</th>
                                            <th scope="col" data-field="caste" data-sortable="false"
                                                data-visible="false">{{ __('caste') }}
                                            </th>
                                            ...
                                            <th scope="col" data-field="guardian_occupation" data-sortable="false"
                                                data-visible="false">
                                            ...
                                            @canany(['student-edit', 'student-delete', 'generate-document'])
                                                <th data-events="studentEvents" data-width="150" scope="col"
                    ...
                    <form id="edit-form" class="edit-student-registration-form" novalidate="novalidate"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <hr>
                                    <h6>{{ __('change_password') }}<small class="text-info">(Leave It Blank If you don't need to change)</small></h6> 
                                </div>
