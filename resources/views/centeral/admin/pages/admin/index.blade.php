...
@push('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard-admin-assets/src/plugins/src/table/datatable/datatables.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard-admin-assets/src/plugins/css/light/table/datatable/dt-global_style.css') }}">
        ...
        <div class="row layout-top-spacing mb-4">
            <div class="widget-content widget-content-area p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="m-0">المشرفيين</h5>
                    <div class="short_actions">
                        @admincan('create-admin')
                            <a href="{{ route('admin-dashboard.admin.create') }}" class="btn btn-light-primary">
