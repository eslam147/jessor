...
@section('title', __('class') . ' ' . __('subject'))
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="section_names" data-sortable="true">
                                        {{ __('section') }}</th>
                                    <th scope="col" data-field="core_subject" data-sortable="true"
                                        data-formatter="coreSubjectFormatter">{{ __('core_subject') }}</th>
                                    <th scope="col" data-field="elective_subject" data-sortable="true"
                                    ...
                                    <th scope="col" data-field="operate" data-sortable="false"
                                        data-events="classSubjectEvents"> {{ __('action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <form class="pt-3 class-edit-form" id="edit-form" action="{{ url('class/subject') }}"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row edit-core-subject-div" style="display: none;">
                                    <div class="col-11">
                                        <div class="form-group">
                                            <input type="hidden" name="edit_core_subject[0][class_subject_id]"
                                                class="edit-class-subject-id form-control" disabled>
                                            <select name="edit_core_subject[0][subject_id]"
                                                class="edit-core-subject-id form-control" required="required" disabled>
                                    ...
                                    <div class="col-1 pl-0">
                                        <button type="button" class="btn btn-icon btn-inverse-danger remove-core-subject"
                                ...
                                <div class="row core-subject-div" style="display: none;">
                                    <div class="col-11">
                                        <div class="form-group">
                                            <select name="core_subject_id[0]" class="core-subject-id form-control"
                                    ...
                                    <div class="col-1 pl-0">
                                        <button type="button" class="btn btn-inverse-success btn-icon add-core-subject"
                                ...
                                <div id="edit-elective-subject-group-div" class="edit-elective-subject-group-div"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-3 align-items-end elective-subject-div">
                                            <input type="hidden" name="edit_elective_subjects[0][class_subject_id][0]"
                                                class="edit-elective-subject-class-id form-control" disabled="true" />
                                            <select name="edit_elective_subjects[0][subject_id][0]"
                                                class="form-control edit-elective-subject-name" disabled="true"
                                                required="required">
                                                <option value="">{{ __('select_subject') }}</option>
                                                @foreach ($subjects as $subject)
                                                    <option value="{{ $subject->id }}"
                                        ...
                                        <div class="col-3 align-items-end elective-subject-div">
                                            <input type="hidden" name="edit_elective_subjects[0][class_subject_id][1]"
                                                class="edit-elective-subject-class-id form-control" disabled="true" />
                                    ...
                                    <div class="form-group row">
                                        <div class="col-3">
                                            ...
                                            <input name="edit_elective_subjects[0][total_selectable_subjects]"
                                                type="number" placeholder="{{ __('total_selectable_subjects') }}"
                                                class="form-control edit-total-selectable-subject" min="1"
                                                max="1" disabled="disabled" required />
                                        </div>
                                    </div>
                                    <hr>
                                </div>
                                ...
                                <div id="elective-subject-group-div" class="elective-subject-group-div"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-3 align-items-end elective-subject-div">
                                            <select name="elective_subjects[0][subject_id][0]"
                                                class="form-control elective-subject-name" disabled="true"
                                                required="required">
                                                <option value="">{{ __('select_subject') }}</option>
                                                @foreach ($subjects as $subject)
                                                    <option value="{{ $subject->id }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-3">
                                            ...
                                            <input name="elective_subjects[0][total_selectable_subjects]" type="number"
