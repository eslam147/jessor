...
class ParentApiController extends Controller
{
    ...
    public function getTimetable(Request $request)
    {
        ...
        try {
            ...
            $timetables = Timetable::where('class_section_id', $children->class_section_id)->with([
    ...
    public function feesPaidReceiptPDF(Request $request)
    {
        try {
            ...
            // $logo = public_path("storag.e/{$logo}");
    ...
    public function getFeesPaymentTransactions(Request $request)
    {
        try {
            ...
            $fees_payment_transactions = PaymentTransaction::whereIn('student_id', $child_id)->with('session_year')->with([
                'student' => function ($q) {
