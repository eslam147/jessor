...
class WebSettingController extends Controller
{
    public function content_index()
    {
        ...
        $about = $settings->get('about_us');
        $whoweare = $settings->get('who_we_are');
        $teacher = $settings->get('teacher');
        $event = $settings->get('events');
        $program = $settings->get('programs');
        $photo = $settings->get('photos');
        $video = $settings->get('videos');
        $faq = $settings->get('faqs');
