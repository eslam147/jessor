jQuery(document).ready(function ($) {
    ...
    function initTimeline(timelines) {
        return timelines.each(function () {
            ...
            timelineComponents["eventsWrapper"].on(
                ...
                function (event) {
                    event.preventDefault();
                    $('.switch_btn').trigger("before-change");
					...
					window.timeline.currentIndex = $(this).parent().index(); //only negative translate value
                    $('.switch_btn').trigger("timeline-changed");
            ...
            var selectedDate =
                ...
                newEvent =
                    string == "next"
						...
						window.timeline.currentIndex = newEvent.parent().index();
    ...
    function updateVisibleContent(event, eventsContent) {
        ...
        selectedContent.attr("class", classEnetering).addClass("opacity-1");
        visibleContent
