...
use App\Http\Controllers\EndUser\CommentController;
...
Route::middleware([
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::prefix('comments')->controller(CommentController::class)->group(function () {            
            Route::get('/{id}', 'index');
            Route::get('/get_replaies_comment/{id}', 'getReplies');
            Route::get('/count_replaies_comment/{id}', 'countReplies');
            Route::get('/edit/{id}', 'edit');
            Route::get('/delete/{id}', 'delete');
            Route::post('/store', 'store');
            Route::post('/update', 'update');
            Route::post('/remove', 'remove');
            Route::post('/replay_comment', 'replay');
        });
    ...
    Route::group(['middleware' => ['Role', 'auth', 'logs-out-banned-user']], function () {
        Route::group(['middleware' => 'language'], function () {
            ...
            //         Route::get('/', 'photo_index')->name('photo.index');
            //         Route::post('photos/store', 'photo_store')->name('photo.store');
            //         Route::get('photos-list', 'photo_show')->name('photo.show');
            //         Route::get('photos/edit/{id}', 'edit_index')->name('edit.index');
            //         Route::post('photos/update', 'photo_update')->name('photo.update');
            //         Route::delete('photos/delete/{id}', 'photo_delete')->name('photo.delete');
            //         Route::post('/image/update', 'image_update')->name('image.update');
            //         Route::delete('/image/delete/{id}', 'image_delete')->name('image.delete');
            //     });

            //     Route::group([], function () {
            //         Route::get('/videos-index', 'video_index')->name('video.index');
            //         Route::post('/videos/store', 'video_store')->name('video.store');
            //         Route::get('/videos-list', 'video_show')->name('video.show');
            //         Route::post('videos/update/{id}', 'video_update')->name('video.update');
            //         Route::delete('videos/delete/{id}', 'video_delete')->name('video.delete');
            //     });
            // });
